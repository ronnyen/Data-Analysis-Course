...
scrape('https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population_density', 'density')
scrape('https://en.wikipedia.org/wiki/List_of_countries_by_employment_rate', 'employment')